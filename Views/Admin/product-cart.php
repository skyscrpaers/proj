...
<head>
    ...
    <title>Product Cart | Nalika - Material Admin Template</title>
                    ...
                    <ul class="metismenu" id="menu1">
                        <li class="active">
                            ...
                            <ul class="submenu-angle" aria-expanded="true">
                                ...
                                <li><a title="Dashboard v.2" href="index-1.html"><span class="mini-sub-pro">Supprimer Commentaire</span></a></li>
                                <li><a title="Dashboard v.3" href="index-2.php"><span class="mini-sub-pro">Afficher Commentaire</span></a></li>
                                <li><a title="Product List" href="product-list.html"><span class="mini-sub-pro">Ajouter Commentairet</span></a></li>
                                <li><a title="Product Edit" href="product-edit.html"><span class="mini-sub-pro">Modifier Reclamation</span></a></li>
                                <li><a title="Product Detail" href="product-detail.html"><span class="mini-sub-pro">Supprimer Reclamation</span></a></li>
                                <li><a title="Product Cart" href="product-cart.php"><span class="mini-sub-pro">Afficher Reclamationt</span></a></li>
...
<TABLE><tr>
        <?php foreach ($contact as $contact): ?>
           <tr></tr> <td>NOM :<?= $contact['nom'] ?></td></tr><tr><td> exp :<?= $contact['exp'] ?></td></tr><tr><td> PRENOM: <?= $contact['prenom'] ?> </td></tr><tr><td>Adresse :<?= $contact['ad'] ?></td></tr><tr><td> SOCIETE : <?= $contact['soc'] ?></td></tr><tr><td> TELEPHONE /<?= $contact['tel'] ?></td></tr><tr>
           <td> EMAIL:<?= $contact['mail'] ?></td></tr><tr><td> NUMERO:<?= $contact['num'] ?></td></tr><tr><td> MODELE: <?= $contact['mode'] ?></td></tr><tr><td> CODE: <?= $contact['code'] ?></td></tr><tr><td>DESCRIPTION:<?= $contact['descr'] ?></td></tr><tr><td> ETAT:<?= $contact['Etat'] ?></td></tr>
            <?php endforeach; ?>
        </tr>
                                    ...
                                    <div class="col-lg-6 col-md-6 col-sm-6 col-xs-6">
                                        <div class="breadcomb-report">
                                            <button>
  <label><a href="imprimerlisteclient.php"> IMPRIMER </a> </button>
</button>
