...
$pdostat=$objetpdo->prepare('SELECT * FROM comentaire');
$ex=$pdostat->execute();
                    ...
                    <ul class="metismenu" id="menu1">
                        <li class="active">
                            ...
                            <ul class="submenu-angle" aria-expanded="true">
                                ...
                                <li><a title="Product List" href="product-list.html"><span class="mini-sub-pro">Ajouter Commentaire</span></a></li>
                                <li><a title="Product Edit" href="product-edit.html"><span class="mini-sub-pro">Modifier Reclamation</span></a></li>
                                <li><a title="Product Detail" href="product-detail.html"><span class="mini-sub-pro">Supprimer Reclamaion</span></a></li>
                                <li><a title="Product Cart" href="product-cart.php"><span class="mini-sub-pro">Afficher Reclamation</span></a></li>
                                    ...
                                    <div class="col-lg-6 col-md-6 col-sm-6 col-xs-6">
                                        <div class="breadcomb-wp">
											...
											<div class="breadcomb-ctn" >
												<h2>Commentaire</h2>
                                                <table>
                                                    <tr><tr><td><?php foreach ($contact as $contact): ?></td></tr>

          <tr><td><h2><?= $contact['text'] ?></h2></td></tr>
           <?php endforeach; ?>
       </tr>
</table>
