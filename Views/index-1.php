        ...
        <nav id="sidebar" class="">
			...
			<div class="nalika-profile">
				<div class="profile-dtl">
					...
					<h2>SkyScapers <span class="min-dtn"></span></h2>
				</div>
				<div class="profile-social-dtl">
					<ul class="dtl-social">
						<li><a href="https://www.facebook.com/mido.zalila"><i class="icon nalika-facebook"></i></a></li>
                    ...
                    <ul class="metismenu" id="menu1">
                        <li class="active">
                            ...
                            <ul class="submenu-angle" aria-expanded="true">
                                <li><a title="Commandes" href="index-1.php"><span class="mini-sub-pro">Dashboard v.1</span></a></li>
                                    ...
                                    <ul class="mobile-menu-nav">
                                        <li><a data-toggle="collapse" data-target="#Charts" href="#">Home <span class="admin-project-icon nalika-icon nalika-down-arrow"></span></a>
                                            <ul class="collapse dropdown-header-top">
                                                <li><a href="index.html">Gestion du commande</a></li>
                                    ...
                                    <div class="col-lg-6 col-md-6 col-sm-6 col-xs-6">
                                        <div class="breadcomb-wp">
											...
											<div class="breadcomb-ctn">
												...
												<p>Welcome to SkySkypers <span class="bread-ntd"></span></p>
											</div>
										</div>
  ...
  <div class="agile-tables">
          <div class="w3l-table-info">
            <div class="agile-tables">
              ...
              <li id="menu-academico-avaliacoes" ><a href="statistique.php">Statistiques du Commandes </a></li>
  <br>
  <br>
  <h2>Liste des commandes</h2>
  <?php $c=new CommandeC();

                 $liste = $c->listCommande();
?>
<div class="w3l-table-info">
...
if (isset($_GET['idcommande'])){
    ...
    $result=$CommandeC->recuperercom($_GET['idcommande']);
...
<tr>
<td>idcommande</td>
<td><input type="text" name="idcommande" value=" $idcommande "></td>
</tr>

<tr>
  <td>etatCmd</td>
  <td><input type="text" name="etatCmd" value=" $etatCmd "></td>
  </tr>
  <tr>
<td></td>
...
<tr>
<td></td>
<td><input type="hidden" name="cin_ini" value=" <?PHP echo $row['idcommande']; ?>"></td>
</tr>
</table>
</form>
<br>
<br>
<h2><a href="imprimerlistecommande.php">Imprimer Liste des commandes</h2>
  <br>
  <br>
  <br>

<h2><a href="envoyerMail.php">Envoyer mail</h2>
...
<li id="menu-academico-avaliacoes" ><a href="statistique.php">statistiques </a></li>
    <!-- jquery
		============================================ -->
