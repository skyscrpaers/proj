			...
			<nav class="navbar navbar-default">
				...
				<div class="collapse navbar-collapse" id="bs-megadropdown-tabs">
					<ul class="nav navbar-nav">
						...
						<li><a href="about.php" class="act">Commentaire</a></li> 
						...
						<li><a href="mail.html">Réclamation</a></li>
					</ul>
				</div>
			</nav>
		</div>
		...
		<div class="container">	
			<div class="w3ls_about_grids">
				<div class="col-md-6 w3ls_about_grid_left">
					...
					<input class="input" type="text" name="texte" placeholder=""><button value="modifier">Ajouter</a>
		...
		<div class="container">
			<div class="w3_footer_grids">
				...
				<div class="col-md-3 w3_footer_grid">
					<h3>Information</h3>
					<ul class="info"> 
						<li><a href="about.html">Commentaire</a></li>
